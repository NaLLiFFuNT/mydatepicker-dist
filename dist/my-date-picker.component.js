...
export var MyDatePicker = (function () {
    function MyDatePicker(elem, renderer, cdr, localeService, utilService) {
        ...
        this.templateBtnSaveClick = new EventEmitter();
        this.templateBtnClearClick = new EventEmitter();
    ...
    MyDatePicker.propDecorators = {
        ...
        'templateBtnSaveClick': [{ type: Output },],
        'templateBtnClearClick': [{ type: Output },],
    };
    return MyDatePicker;
}());
